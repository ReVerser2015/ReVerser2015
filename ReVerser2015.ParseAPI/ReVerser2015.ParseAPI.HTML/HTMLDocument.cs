...
namespace ReVerser2015.ParseAPI.HTML
{
	...
	public partial class HTMLDocument
	{
        ...
        /// <summary>
        /// Creates an instance of an HTML document and loads the string containing the HTML document.
        /// </summary>
        ...
        /*--------------Added by ReVerser2015 16.06.2015--------------*/

        /// <summary>
        /// Gets the body node of the document.
        /// </summary>
        public HTMLNode Body
        {
            get
            {
                return DocumentNode.GetElementByTagName("body");
            }
            set
            {
                DocumentNode.ReplaceChild(value, DocumentNode.GetElementByTagName("body"));
            }
        }
        ...
        /// <summary>
        /// Saves the HTML document to string and returns it.
        /// </summary>
        public string Save()
        {
            return DocumentNode.WriteTo();
        }
        ...
        /// <summary>
        /// Returns the string containing the whole HTML document text.
        /// </summary>
		...
		private void ReadDocumentEncoding(HTMLNode node)
		{
			...
			if (content != null)
			{
				...
				{
					// The following check fixes the the bug described at: http://ReVerser2015.ParseAPI.HTML.codeplex.com/WorkItem/View.aspx?WorkItemId=25273
